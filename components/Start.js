        ...
        <div className='w-full flex justify-center bg-gray-50'>
            <div className='max-w-3xl w-full '>
                ...
                <div className='w-full gap-4 grid grid-flow-row  xl:grid-cols-3 md:grid-cols-2 grid-cols-1 py-8'>
                    <div onClick={openNew} className='bg-white flex-col w-48 h-64 hover:shadow-md select-none rounded-xl border border-gray-300 flex items-center justify-center mx-auto'>
